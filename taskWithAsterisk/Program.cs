...
void CountingProgrammers()
{
    ...
    while (x1 > 999) { x1 = value / 10; }
    if (x < 5 && x > 1)
    {

        Console.WriteLine(value + " программиста ");
    }
    else if (x == 1)
    {
        Console.WriteLine(value + " программист ");
    }
    else
    {
        Console.WriteLine(value + " программистов ");
    }
}
